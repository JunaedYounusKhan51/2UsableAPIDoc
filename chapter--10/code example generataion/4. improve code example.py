...
openai.api_key = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
...
lazy_doc_df = pd.read_excel("lazy_doc_cycle"+str(prev_cycle_int)+"_final.xlsx")
	...
	try:
		if 'error' in output_msg.lower():
			...
			response = completions_with_backoff(
			    engine="text-davinci-003", #"text-davinci-003" #"code-davinci-002",
			    prompt=prompt,
			    temperature=0.7,
			    max_tokens=512,#768,
			    top_p=1,
